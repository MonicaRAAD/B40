...
const AD_AdiEntryType APPL_asAdiEntryList[] =
{
   ...
   { 0x2,  "SPEED1",     ABP_UINT16,   1, APPL_WRITE_MAP_READ_ACCESS_DESC,{ { &appl_iSpeed,    &appl_sUint16Prop } } },
   {  0x3,  "REF_SPEED", ABP_UINT16,   1, APPL_READ_MAP_WRITE_ACCESS_DESC, { { &appl_iRefSpeed, &appl_sUint16Prop } } },
   {  0x4,  "REF_SPEED1", ABP_UINT16,   1, APPL_READ_MAP_WRITE_ACCESS_DESC,{ { &appl_iRefSpeed, &appl_sUint16Prop } } }
};
